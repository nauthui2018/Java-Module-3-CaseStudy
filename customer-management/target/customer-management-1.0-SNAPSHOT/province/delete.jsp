                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    <span class="au-breadcrumb-span" style="font-size: larger">Deleting province</span>
                                </div>
                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Province ID</label>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Province Code</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input value="${province.getProvinceCode()}" disabled type="text" name="provinceCode" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                <a type="cancel" class="btn btn-warning btn-sm" href="${pageContext.request.contextPath}/provinces">

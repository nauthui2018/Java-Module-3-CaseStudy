                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="firstName" value="${customer.firstName}" placeholder="First Name" class="form-control" required>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" name="totalOrders" value="${customer.totalOrders}" placeholder="Total Orders" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" id="text-input" name="totalAmounts" value="${customer.totalAmounts}" placeholder="Total Amounts" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">

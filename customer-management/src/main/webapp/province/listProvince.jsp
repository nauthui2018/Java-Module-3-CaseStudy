                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    <a href="${pageContext.request.contextPath}/provinces">All Provinces</a>
                                </div>
                                <p>
                                ...
                                <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/provinces?action=add">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive m-b-40">
                                <table class="table table-borderless table-data3">
                                    ...
                                    <tr>
                                        <th>Province ID
                                            <a href="${pageContext.request.contextPath}/provinces?action=sortByID">
                                                <i class="fa fa-sort ml-1"></i></a>
                                        </th>
                                        <th>Province Name
                                            <a href="${pageContext.request.contextPath}/provinces?action=sortByName">
                                                <i class="fa fa-sort ml-1"></i></a>
                                        </th>
                                        <th>Province Code
                                            <a href="${pageContext.request.contextPath}/provinces?action=sortByCode">
                                                <i class="fa fa-sort ml-1"></i></a>
                                        </th>
                                        <th>Actions</th>
                                    </tr>

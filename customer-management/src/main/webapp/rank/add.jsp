                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    <span class="au-breadcrumb-span" style="font-size: larger">Adding new rank</span>
                                </div>
                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="rankName" placeholder="Rank Name" class="form-control">
                                                <small class="form-text text-muted">Please enter rank name</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                ...
                                                <a type="reset" class="btn btn-danger btn-sm" href="${pageContext.request.contextPath}/ranks?action=add">

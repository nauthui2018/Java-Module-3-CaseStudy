                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input value="${customer.firstName}" id="text-input" type="text" name="firstName" placeholder="First Name" class="form-control" required>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.lastName}" type="text" name="lastName" placeholder="Last Name" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.dob}" type="date" id="date-input" name="dob" placeholder="DOB" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.mobile}" type="text" name="mobile" placeholder="Mobile" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.address}" type="text" name="address" placeholder="Address" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.email}" type="email" id="email-input" name="email" placeholder="Email" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.totalOrders}" type="number" name="totalOrders" placeholder="Total Orders" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                                        <c:if test="${(item.key).equals('totalOrders')}">
                                                            <span class="message" style="color: red; font-size: smaller">${item.value}</span>
                                                        </c:if>
                                                    </c:forEach>
                                                </label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.totalAmounts}" type="number" name="totalAmounts" placeholder="Total Amounts" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                                        <c:if test="${(item.key).equals('totalAmounts')}">
                                                            <span class="message" style="color: red; font-size: smaller">${item.value}</span>
                                                        </c:if>
                                                    </c:forEach>
                                                </label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="rankID" id="rankID" class="form-control" required>
                                                    ...
                                                    <c:if test="${customer.rankID != null}">
                                                ...
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                                        <c:if test="${(item.key).equals('rankID')}">
                                                            <span class="message" style="color: red; font-size: smaller">${item.value}</span>
                                                        </c:if>
                                                    </c:forEach>
                                                </label>
